...
# Description
This was developed to solve the issue of spraying several protocols simultaneously. The tool 𝘀𝗽𝗿𝗮𝘆𝗺𝗲 first dynamically identifies all the protocols netexec (nxc) has available, takes a simple `'USERNAME:PASSWORD'` and `<HOSTS_FILE>` then continues to spray everything into infinity!
